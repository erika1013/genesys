...
@Entity
public class PlanPrueba extends Auditoria implements Serializable {
	...
	public PlanPrueba(Long planpruebasid) {
	...
	public boolean equals(Object object) {
		...
		// not set
		if (!(object instanceof PlanPrueba)) {
			return false;
		}
		PlanPrueba other = (PlanPrueba) object;
