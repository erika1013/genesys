 ...
 */
@Entity
public class EmpleadoEstado extends Auditoria implements Serializable {
	...
	public EmpleadoEstado(Long estadoId) {
	...
	public String toString() {
		return "com.guandera.talento.shared.model.EmpleadoEstado[ estadoId=" + estadoId + " ]";
	}
