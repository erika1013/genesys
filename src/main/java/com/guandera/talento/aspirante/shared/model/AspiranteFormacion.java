 ...
 */
@Entity
public class AspiranteFormacion extends Auditoria implements Serializable {
	...
	public AspiranteFormacion() {
	}

	public AspiranteFormacion(Long formacionid) {
	...
	public boolean equals(Object object) {
		...
		// not set
		if (!(object instanceof AspiranteFormacion)) {
			return false;
		}
		AspiranteFormacion other = (AspiranteFormacion) object;
	...
	public String toString() {
		return "com.guandera.talento.shared.model.AspiranteFormacion[ formacionid=" + formacionid + " ]";
	}
