 ...
 */
@Entity
public class AspiranteReferencia extends Auditoria implements Serializable {
	...
	public AspiranteReferencia() {
	}

	public AspiranteReferencia(Long referenciaid) {
	...
	public boolean equals(Object object) {
		...
		// not set
		if (!(object instanceof AspiranteReferencia)) {
			return false;
		}
		AspiranteReferencia other = (AspiranteReferencia) object;
	...
	public String toString() {
		return "com.guandera.talento.shared.model.AspiranteReferencia[ referenciaid=" + referenciaid + " ]";
	}
